...
cp -r lib/google "$build_bin_dir"
cp -r lib/protobuf "$build_bin_dir"

cp -r "$build_gen_dir/google/"* "$build_bin_dir/google"
cp -r "$build_gen_dir/protobuf/"* "$build_bin_dir/protobuf"
